...
if velocidade > 80:
    print("Que pena! Por ter ultrapassado o limite de 80km/h da via em\n{}km/h, você foi multado. O valor da multa será de R${:.2f}!".format(velocidadeExcedida, velocidadeExcedida * 7))
else:
